...
if ~isfield(subject,'id') || ~isfield(subject,'exam_id') || ~isfield(subject,'analysis_dir') || ~isfield(subject,'dtype')
    ...
    items={'preproc','concat','readingevents','artifactrejection','artifactrejectionICA','MRI_ctf','MRI_seg_SUMA','vigilance','hdmSUMA_nmriSUMA150_fs6_openmeeg','processing_sensor'};
